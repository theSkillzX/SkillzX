...
const Category = () => {
  return (
    <section className="py-0 md:py-0 bg-white dark:text-gray mt-20" id="courses">
    ...
    <div className="w-[80%] m-auto grid grid-cols-1  gap-x-12 gap-y-8 lg:grid-cols-4 ">
      <article className="flex flex-col rounded-xl bg-darkwhite3">
        <div className="flex flex-col flex-1 p-6">
          <p rel="noopener noreferrer" className="text-xl tracking-wider uppercase hover:underline dark:text-berry font-bold">
      ...
      <article className="flex flex-col rounded-xl bg-darkwhite3">
        <div className="flex flex-col flex-1 p-6">
          <p rel="noopener noreferrer" href="#" className="text-xl tracking-wider uppercase hover:underline dark:text-berry font-bold">
